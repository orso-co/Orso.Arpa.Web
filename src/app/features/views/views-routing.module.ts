...
const routes: Routes = [
  {
    ...
    children: [
      ...
      { path: 'register', component: RegisterPageComponent, data: { sessionPrevent: true, title: 'REGISTER' } },
      {
        path: 'activation',
        component: ActivationPageComponent,
        data: { sessionPrevent: true, title: 'ACCOUNT_ACTIVATION' },
      },
      {
        path: 'regError',
        component: RegErrorPageComponent,
        data: { sessionPrevent: true, title: 'REGISTRATION_ERROR' },
      },
      {
        path: 'forgotPassword',
        component: ForgotPasswordPageComponent,
        data: { sessionPrevent: true, title: 'FORGOT_PASSWORD' },
      },
      {
        path: 'eMailConfirmation',
        component: EmailConfirmationPageComponent,
        data: { sessionPrevent: true, title: 'EMAIL_CONFIRMATION' },
      },
      { path: 'logout', component: LogoutPageComponent, data: { title: 'LOGOUT' } },
      { path: 'privacy', component: PrivacyPageComponent, data: { title: 'PRIVACY' } },
    ],
  },
];
