...
export class ProjectListComponent {
  ...
  constructor(private route: ActivatedRoute, private dialogService: DialogService, public translate: TranslateService) {
    this.getRouteData();
  ...
  public openProjectDetailDialog(oldProject: IProjectDto | null): void {
    ...
    ref.onClose.pipe(first()).subscribe((newProject: IProjectDto) => {
